...
namespace Bicep.LangServer.UnitTests.Handlers
{
    ...
    public class BicepBuildCommandHandlerTests
    {
        ...
        public void Handle_WithInvalidPath_ShouldThrowArgumentException(string path)
        {
            ...
            BicepBuildCommandHandler bicepBuildCommandHandler = new BicepBuildCommandHandler(bicepCompilationManager, Serializer, BicepTestConstants.Features, BicepTestConstants.EmitterSettings, BicepTestConstants.NamespaceProvider, FileResolver, ModuleDispatcher, configurationManager, BicepTestConstants.ApiVersionProvider);
...
resource dnsZone 'Microsoft.Network/dnsZones@2018-05-01' = {
  ...
  location: 'global'
            ...
            BicepBuildCommandHandler bicepBuildCommandHandler = new BicepBuildCommandHandler(bicepCompilationManager, Repository.Create<ISerializer>().Object, BicepTestConstants.Features, BicepTestConstants.EmitterSettings, BicepTestConstants.NamespaceProvider, FileResolver, ModuleDispatcher, configurationManager, BicepTestConstants.ApiVersionProvider);
            string expected = await bicepBuildCommandHandler.Handle(bicepFilePath, CancellationToken.None);
