...
namespace Bicep.Core.IntegrationTests
{
    ...
    public class TypeValidationTests
    {
        private static SemanticModel GetSemanticModelForTest(string programText, INamespaceProvider nsProvider)
        {
            ...
            var compilation = new Compilation(BicepTestConstants.Features, nsProvider, SourceFileGroupingFactory.CreateFromText(programText, BicepTestConstants.FileResolver), configuration, BicepTestConstants.ApiVersionProvider, new LinterAnaslyzer(configuration));
