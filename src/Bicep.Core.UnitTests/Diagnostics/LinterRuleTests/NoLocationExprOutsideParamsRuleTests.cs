...
namespace Bicep.Core.UnitTests.Diagnostics.LinterRuleTests
{
    ...
    public class NoLocationExprOutsideParamsRuleTests : LinterRuleTestsBase
    {
        ...
        protected void ExpectPass(string bicepText, OnCompileErrors onCompileErrors = OnCompileErrors.Include)
        {
            AssertLinterRuleDiagnostics(NoLocationExprOutsideParamsRule.Code, bicepText, new string[] { }, onCompileErrors);
        }

        protected void ExpectFail(string bicepText, string expectedMessage, OnCompileErrors onCompileErrors = OnCompileErrors.Include)
        {
            AssertLinterRuleDiagnostics(NoLocationExprOutsideParamsRule.Code, bicepText, new string[] { expectedMessage }, onCompileErrors);
        }

        protected void ExpectFailWithFix(string bicepText, string expectedMessage, ExpectedCodeFix expectedFix, OnCompileErrors onCompileErrors = OnCompileErrors.Include)
        {
        ...
        [DataRow(@"
          ...
          ",
            OnCompileErrors.Ignore)]
        [DataTestMethod]
        public void If_Not_DeploymentOrResourceGroup_OrWithIncorrectNamespace_ShouldPass(string text, OnCompileErrors onCompileErrors = OnCompileErrors.Include)
        {
