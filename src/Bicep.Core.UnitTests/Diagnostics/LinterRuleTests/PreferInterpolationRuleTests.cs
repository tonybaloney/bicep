...
namespace Bicep.Core.UnitTests.Diagnostics.LinterRuleTests
{
    ...
    {
        private void ExpectPass(string text, OnCompileErrors onCompileErrors = OnCompileErrors.Include)
        {
        ...
        private void ExpectDiagnosticWithFix(string text, string expectedFix, OnCompileErrors onCompileErrors = OnCompileErrors.Include)
        {
            ExpectDiagnosticWithFix(text, new string[] { expectedFix }, onCompileErrors);
        }

        private void ExpectDiagnosticWithFix(string text, string[] expectedFixes, OnCompileErrors onCompileErrors = OnCompileErrors.Include)
        {
            AssertLinterRuleDiagnostics(PreferInterpolationRule.Code, text, onCompileErrors, diags =>
            {
        ...
        [DataTestMethod]
        public void ArgsNotStrings_DoNotSuggestFix(string text, OnCompileErrors onCompileErrors = OnCompileErrors.Include)
        {
